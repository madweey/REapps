...
class MeetingsController:
    ...
    def _build_modals(self):
        ...
        # Модальное окно «Информация о встрече» и аудиоплеер
    ...
    # ----------------------------------------------------
    # Слоты с блокировкой прошедшего времени
    # ----------------------------------------------------
